...
with reconstructed request times (`.cpureq`), command-engine scoring, or a
`.cpureq` replay, respectively. Buffer depth is visible: `--qdepth=2` falls
from 263 to 208 exact captures.
