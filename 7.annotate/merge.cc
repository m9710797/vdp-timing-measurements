...
void printCSV(map<int, map<int, Access>>& tab, const vector<pair<string, int>>& files)
{
	// heading
	for (auto& p : files) {
		cout << "\t\t\t";
...
void printASCII(map<int, map<int, Access>>& tab, const vector<pair<string, int>>& files)
{
	// heading
	cout << "       ";
	for (auto& p : files) {
